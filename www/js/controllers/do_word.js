angular.module('starter.controllers')
  .controller('doword_ctrl', ['$scope', '$rootScope', '$http', '$stateParams', '$interval', '$ionicScrollDelegate', '$timeout', function($scope, $rootScope, $http, $stateParams, $interval, $ionicScrollDelegate, $timeout) {
